...
const TABS = [
  ...
  { id: 'expenses',    label: 'مصروفاتي',  icon: ExpenseIcon },
...
function ExpenseIcon({ active }) {
  return <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={active ? '#6C63FF' : '#5C5A8A'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"/></svg>;
}
