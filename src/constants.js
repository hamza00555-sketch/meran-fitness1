...
export const MUSCLE_GROUPS = {
  Chest: {
    ...
    exercises: [
      ...
      { name: 'Cable Chest Fly (High-to-Low)', videoUrl: 'https://www.youtube.com/results?search_query=Cable+Chest+Fly+High+to+Low+proper+form+shorts', tips: ['البكرتان في الأعلى والحركة للأسفل', 'تستهدف الصدر السفلي بشكل ممتاز', 'المرفقان مثنيان قليلاً طوال الحركة'] },
    ],
  },
  Back: {
    ...
    exercises: [
      ...
      { name: 'Cable Row',            videoUrl: 'https://www.youtube.com/results?search_query=Cable+Row+proper+form+shorts', tips: ['الظهر مستقيم لا تميل للخلف', 'اسحب للسرة مع الضغط على الظهر', 'المرفقان للخلف وليس للجانبين'] },
      ...
      { name: 'Unilateral Dumbbell Row',    videoUrl: 'https://www.youtube.com/results?search_query=Unilateral+Dumbbell+Row+proper+form+shorts', tips: ['الظهر موازٍ للأرض والجذع ثابت', 'اسحب الكوع للأعلى والخلف', 'لا تدور بالجذع أثناء السحب'] },
      ...
      { name: 'Wide Grip Seated Cable Row', videoUrl: 'https://www.youtube.com/results?search_query=Wide+Grip+Cable+Row+proper+form+shorts', tips: ['المسكة العريضة تستهدف العضلة العريضة أكثر', 'اسحب للصدر العلوي لا السرة', 'الظهر مستقيم لا تميل للخلف'] },
      { name: 'Barbell Bent Over Row',      videoUrl: 'https://www.youtube.com/results?search_query=Barbell+Bent+Over+Row+proper+form+shorts', tips: ['الظهر موازٍ للأرض أو قريب منه', 'اسحب نحو السرة لا الصدر', 'اضغط لوحَي الكتف معاً في نهاية الحركة'] },
  ...
  Shoulders: {
    ...
    exercises: [
      ...
      { name: 'Dumbbell Reverse Fly',           videoUrl: 'https://www.youtube.com/results?search_query=Dumbbell+Reverse+Fly+proper+form+shorts', tips: ['أمِل للأمام من الوسط 45 درجة', 'ارفع الذراعين للجانبين محافظاً على الخم', 'ركز على الضغط خلف الكتف'] },
    ],
  },
  Legs: {
    ...
    exercises: [
      ...
      { name: 'Calf Raise',            videoUrl: 'https://www.youtube.com/results?search_query=Calf+Raise+proper+form+shorts', tips: ['اسحب على أصابع القدم بالكامل', 'الإرجاع البطيء للأسفل لمدى كامل', 'الساق مفردة أصعب وأكثر تأثيراً'] },
      ...
      { name: 'Barbell Back Squat',        videoUrl: 'https://www.youtube.com/results?search_query=Barbell+Back+Squat+proper+form+shorts', tips: ['البار على العضلة الشوكية لا الرقبة', 'الظهر مستقيم والصدر مرفوع', 'انزل حتى الفخذ موازٍ للأرض على الأقل'] },
      ...
      { name: 'Barbell Hip Thrust',        videoUrl: 'https://www.youtube.com/results?search_query=Barbell+Hip+Thrust+proper+form+shorts', tips: ['الكتفان على المقعد والبار على الحوض', 'ارفع الوركين حتى الامتداد الكامل', 'اضغط الأرداف بقوة في أعلى نقطة'] },
